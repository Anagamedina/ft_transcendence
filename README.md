...
| Development seed data (org, users, sites, sensors) | Implemented | Daruny       | `cd backend && python -m seeds.seed_demo` (idempotent — safe to re-run, no duplicates)                        |
| Authentication                                     | Planned     | TBD          | Add test or endpoint link                                                                                     |
